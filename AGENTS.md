...
- Every commit ends with exactly this footer. The generic "Codex"
  ...
  (a family name, a numbered release, a `Codex-*` identifier):

      Co-Authored-By: Codex <noreply@anthropic.com>
      Codex-Session: <this session's identifier>
